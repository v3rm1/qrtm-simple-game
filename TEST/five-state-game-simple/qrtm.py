...
class TsetlinMachine:
	...
	def sum_up_clause_votes(self):
		...
		output_sum = 0
		for j in range(self.number_of_clauses):
			output_sum += (j+1) * self.clause_output[j]*self.clause_sign[j]
	...
	def predict(self, X):
		...
		# Converting the clause votes into probability
		output_value = output_sum/self.number_of_clauses
	...
	def fit(self, X, y, number_of_examples=1, epochs=100):
		j = 0
		l = 0
		epoch = 0
		example_id = 0
