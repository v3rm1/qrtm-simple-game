...
class CustomDiscretizer:
    ...
    def cartpole_binarizer(self, input_state, n_bins=15, bin_type="S"):
        if bin_type == "B":
            ...
            op_1 = self._less_than_binned_binarizer(input_state[0], -1.5, 1.5, n_bins+1)
            op_2 = self._less_than_binned_binarizer(input_state[1], -100, 100, n_bins+1)
            op_3 = self._less_than_binned_binarizer(input_state[2], -15, 15, n_bins+1)
            op_4 = self._less_than_binned_binarizer(input_state[3], -100, 100, n_bins+1)
